			...
			<div class="row center_o1 text-center">
				<div class="col-md-12">
					...
					<h5 class="bg_dark d-inline-block p-4 mb-0 mt-4 pt-2 pb-2 fw-normal col_red"><a class="text-white"
							href="#">Home</a> <span class="me-2 ms-2 text-muted"> /</span> About Us</h5>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row about_1">
				<div class="col-md-6">
					<div class="about_1l">
						...
						<hr class="line">
						<h5 class="mt-4">How it All Started Event and manage this this is event how to given pas and how
							to participate</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor nt ut labore
							...
							proident,</p>
						<p class="mb-0">sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut
							perspiciatis de omnis iste natus error sit voluptatem tium doloremque laudantium, totam rem
							am, eaque ipsa quae ab illo inventore veritatis</p>
					</div>
				</div>
				<div class="col-md-6">
					<div class="about_1r">
			...
			<div class="row event1 mt-4">
				...
				<div class="col-md-6 ps-0">
					<div class="event1r bg-white p-4 shadow_box">
						...
						<p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiud tempor
							incididunt ut labore et dolore magna aliqua. Ut enim ad quis nostrud exercitation ullamco
							laboris nisi ut aliquip ex ea commodo is aute irure dolor in reprehenderit in voluptate
							velit esse cillum fugiat nulla pariatur Excepteur sint. Read More</p>
						<ul class="mt-4 mb-0">
							<li class="text-center d-inline-block fw-normal me-3"><span
									class="d-inline-block bg_red text-white rounded-circle fs-2 mb-2">55</span> <br>
								Days</li>
							<li class="text-center d-inline-block fw-normal me-3"><span
									class="d-inline-block bg_red text-white rounded-circle fs-2 mb-2">18</span> <br>
								Hours</li>
							<li class="text-center d-inline-block fw-normal me-3"><span
									class="d-inline-block bg_red text-white rounded-circle fs-2 mb-2">15</span> <br>
								Mins</li>
							<li class="text-center d-inline-block fw-normal"><span
									class="d-inline-block bg_red text-white rounded-circle fs-2 mb-2">23</span> <br>
								Secs</li>
						</ul>
					</div>
				</div>
							...
							<div class="col-md-10 ps-0">
								<div class="news_1rir p-4 bg-white">
									...
									<p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec
										sagittis sem nibh id elit. amet nibh vulputate part the maintacne of the greek
										name of name cursus.</p>
									<h6 class="mb-0"> <i class="fa fa-user col_red me-1"></i> <a href="#">Eget Nulla</a>
										<span class="text-muted me-2 ms-2">|</span> <i
											class="fa fa-comments col_red me-1"></i> <a href="#"> Room No. 17</a>
									</h6>
								</div>
							</div>
						</div>
									...
									<div class="events_1i1 clearfix position-relative">
										...
										<div class="events_1i1i1 clearfix position-absolute bottom-0 text-center w-100">
											<ul class="d-inline-block mb-0 p-2 ps-4 pe-4">
												<li class="d-inline-block me-3"><a href="#"><i
				...
				<div class="col-md-6">
					<div class="faq_1l text-center bg_red p-4 rounded-3">
						...
						<textarea placeholder="Comment"
							class="form-control rounded-0 form_text mt-3 bg-transparent"></textarea>
							...
							<div class="accordion-item">
								...
								<div id="collapseOne" class="accordion-collapse collapse show"
									...
									<div class="accordion-body">
										...
										discretion reasonably. Carriage we husbands advanced an perceive greatest.
