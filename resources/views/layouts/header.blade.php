                    ...
                    <ul class="navbar-nav mb-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu drop_1" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="blog.html"> Hollywood</a></li>
                                <li><a class="dropdown-item border-0" href="blog_detail.html"> Bollywood</a></li>
                            </ul>
                        </li>
                             ...
                             @if (Route::has('login'))
                                <div class="">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}" x-data>
                                        ...
                                        <button class="nav-link button" @click.prevent="$root.submit();">
                                            {{ __('Log Out') }}
                                        </button>
                                    </form>
                                    @else
                                        <a href="{{ route('login') }}" class="nav-link button">Log in</a>
